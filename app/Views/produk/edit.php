                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12 mt-3">
                                            <img id="image-preview" src="<?= base_url('uploads/' . $produk['foto']); ?>" alt="Selected Image" width="100">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="nama_produk">Nama Produk</label>
                                        <input type="text" class="form-control <?= (session('errors.nama_produk')) ? 'is-invalid' : ''; ?>" id="nama_produk" name="nama_produk" placeholder="Nama Produk" value="<?= $produk['nama_produk']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= (session('errors.pemilik_produk')) ? 'is-invalid' : ''; ?>" id="pemilik_produk" name="pemilik_produk" placeholder="Nama Pemilik Produk" value="<?= $produk['pemilik_produk']; ?>">
